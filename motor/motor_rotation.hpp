...
public:
	...
	motor_rotation(_tim_handle, _tim_channel),gpio_port(_gpio_port), ucs3_rotation(nullptr, 0, _reverse_swtich), tim_handle_inverse(_tim_handle_inverse), tim_channel_inverse(_tim_channel_inverse){}
    void rotate(float) override;
};
#endif